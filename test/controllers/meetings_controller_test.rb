...
class MeetingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create meeting" do
    assert_difference("Meeting.count") do
      post meetings_url, params: { meeting: { scheduled_for: @meeting.scheduled_for, title: @meeting.title } }
    end
  ...
  test "should update meeting" do
    patch meeting_url(@meeting), params: { meeting: { scheduled_for: @meeting.scheduled_for, title: @meeting.title } }
